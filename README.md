...
- fingerprint sensor
- webside or an application to use smart lock through mobile
  
  
This project is continiously evolving as I learn new concepts in python through CS50P and other resources. More exciting versions are coming soon!
